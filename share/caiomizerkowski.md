# Personal git message heavy inspired on Wilson Mar example (Caio Mizerkowski)

Added by: [CaioMizerkowski](https://github.com/CaioMizerkowski)
...
"vscodeGitCommit.variables": {
  ...
  "aliasesIcons": [
    ...
    {
      "label": "🚨",
      "detail": "🚨 = Removing linter warnings."
    },
    {
      "label": "⏪",
